...
echo -e "${YELLOW}🔌 Remote Camera Connection Script${NC}"
...
execute_remote_command() {
    ...
    if [ $exit_code -eq 0 ]; then
        ...
        echo ""
        echo "Your Sony A6400 camera should now be accessible via:"
        echo "• Samba share: smb://$PI_HOST/SonyA6400"
        echo "• Direct mount: /mnt/camera on the Raspberry Pi"
    else
        ...
        echo "• connect-camera.sh script not found"
    fi
